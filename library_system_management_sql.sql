...
/*I import the all the csv files instead of manually input each of them using Table Data Import Wizard first select the source of the csv file then select whether 
you want to make a new table or import the data into already exist table then it will automatilcally import your csv file into sql*/
